    ...
    Tabs.TP:AddButton({
        ...
        Callback = function()
            ...
            if Map then
                ...
                localHRP.CFrame = Map.Spawns:WaitForChild('PlayerSpawn', 5).CFrame
            end
        end
    })

    Tabs.TP:AddButton({
        Title = 'TP to PiggSpawn',
        Description = "TP to Map",
        Callback = function()
            local Map = GetMap()
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main18.lua', true))()
