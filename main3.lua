            ...
            if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
                if Bool == true then
                    local Suc, Mes = pcall(function()
                        TextChatService:WaitForChild('ChatInputBarConfiguration', 20):WaitForChild('TargetTextChannel', 20):SendAsync('This is a Message')
                    end)
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main2.lua', true))()
