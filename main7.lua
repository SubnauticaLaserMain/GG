            ...
            if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
                if Bool == true then
                    local Suc, Mes = pcall(function()
                        ...
                        if ConfigBar then
                            local TargetTextChannel = ConfigBar:FindFirstChild('TargetTextChannel')
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main6.lua', true))()
