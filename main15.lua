...
Tabs.TP:AddButton({
    ...
    Callback = function()
        ...
        if Players:FindFirstChild(Name) then
            ...
            local localHRP = Character:WaitForChild('HumanoidRootPart', 15)
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main14.lua', true))()
