                ...
                if Bool == true then
                    local Suc, Mes = pcall(function()
                        ...
                        if DefaultFolder then
                            local SendMessageRemote = DefaultFolder:WaitForChild('SayMessageRequest', 10)


                            if SendMessageRemote then
                                SayMessageRequest:FireServer(unpack({
                                    [1] = Message,
                                    [2] = 'All'
                                }))
                            end
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main10.lua', true))()
