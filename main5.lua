            ...
            if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
                if Bool == true then
                    local Suc, Mes = pcall(function()
                        local ConfigBar = TextChatService:WaitForChild('ChatInputBarConfiguration', 20)
                        
                        if ConfigBar then
                            local TargetTextChannel = ConfigBar:WaitForChild('TargetTextChannel', 20)
...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/SubnauticaLaserMain/GG/main/main3.lua', true))()
